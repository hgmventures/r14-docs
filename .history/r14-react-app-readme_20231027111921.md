...
```
In class components the R14.connect() HOC is used to inject the app context into the components props using the app prop. In the example below the app context is accessed using **this.props.app**. Please note, instead of **domain** and **navigation** the abbreviations **dm** and **nav** are used. 
```jsx
...
``` 
In functional components the R14.withApp() HOC is used to  
```jsx
