...
### Navigating Between Screens
Navigation is very simple in the r14 react app using the **nav** class in the app context. Below are simple examples of navigating between screens. For 
...
<Button
  ...
  onPress={() =>
    this.props.redirect
      ? this.props.app.nav.to(this.props.redirect, { canceled: true })
